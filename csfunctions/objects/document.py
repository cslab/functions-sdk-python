...
class Document(BaseObject):
    ...
    category1_name_ja: str | None = Field(None, description="Main Category")
    category1_name_zh: str | None = Field(None, description="Main Category")
    category2_name_en: str | None = Field(..., description="Category")
    category2_name_de: str | None = Field(..., description="Category")
    category2_name_ja: str | None = Field(None, description="Category")
    category2_name_zh: str | None = Field(None, description="Category")
