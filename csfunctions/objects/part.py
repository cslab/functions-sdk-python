...
class Part(BaseObject):
    ...
    cssaas_benennung3_ja: str | None = Field(None, description="Supplementary Name")
    cssaas_benennung3_zh: str | None = Field(None, description="Supplementary Name")
    ...
    t_kategorie_name_ja: str | None = Field(None, description="Category Name")
    t_kategorie_name_zh: str | None = Field(None, description="Category Name")
    ...
    gebrauchsstand_name_ja: str | None = Field(None, description="Usage Status")
    gebrauchsstand_name_zh: str | None = Field(None, description="Usage Status")
    ...
    mengeneinheit_name_ja: str | None = Field(None, description="Quantity Unit")
    mengeneinheit_name_zh: str | None = Field(None, description="Quantity Unit")
    ...
    surface_name_ja: str | None = Field(None, description="Surface")
    surface_name_zh: str | None = Field(None, description="Surface")
